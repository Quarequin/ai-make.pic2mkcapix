...
const CHAR_TABLE = "0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz+/#";

// ============================================================
// PRE-COMPUTED BAYER MATRICES CONST (Classical)
// ============================================================
const BAYER4_SRC = [
	0, 8, 2, 10,
	12, 4, 14, 6,
...
// ============================================================
// PRE-COMPUTED BLUE NOISE MATRICES CONST
// ============================================================
const BLUE8_SRC = [
...
// ============================================================
const BAYER4 = new Uint8Array(BAYER4_SRC);

const BAYER8 = new Uint8Array(BAYER8_SRC);

const BAYER16 = new Uint8Array(BAYER16_SRC);

// ============================================================
// PRE-COMPUTED BLUE NOISE MATRICES
// ============================================================
const BLUE8 = new Uint8Array(BLUE8_SRC);

const BLUE16 = new Uint8Array(BLUE16_SRC);

const BLUE32 = new Uint8Array(BLUE32_SRC);
...
// ============================================================
const BAYER4_F32 = new Float32Array(BAYER4_SRC.map(v => v / 16.0));

const BAYER8_F32 = new Float32Array(BAYER8_SRC.map(v => v / 64.0));

const BAYER16_F32 = new Float32Array(BAYER16_SRC.map(v => v / 256.0));
...
// PRE-COMPUTED BLUE NOISE MATRICES
// ============================================================
const BLUE8_U8 = new Uint8Array(BLUE8_SRC);

const BLUE16_U8 = new Uint8Array(BLUE16_SRC);

const BLUE32_U8 = new Uint8Array(BLUE32_SRC);
